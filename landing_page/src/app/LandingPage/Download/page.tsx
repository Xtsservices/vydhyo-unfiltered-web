...
const Download: React.FC = () => {
    return (
        <div
            style={{
                background: "linear-gradient(90deg, #0E82FD 0%, #00C6FB 100%)",
                borderRadius: "40px",
                padding: "60px 0",
                display: "flex",
        ...
        >
            ...
            >
                ...
                >
                    Coming soon Vydhyo - India's<br />Trusted Doctors App!
                </h1>
                <p
                    style={{
                        color: "#e6f7ff",
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ marginRight: 8 }}>
                            ...
                            <path d="M12 8V12L15 15" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        24x7 Doctor Support
                    </div>
                    <div style={{ 
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ marginRight: 8 }}>
                            <path d="M22 12H18L15 21L9 3L6 12H2" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        ₹0 Consultation Fee*
                    </div>
                </div>

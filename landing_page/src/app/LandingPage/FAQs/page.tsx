...
You can disable cookies via your browser without affecting core functionality.`
    },
    {
        ...
        answer: "Some services may be integrated via trusted third parties (e.g., payment gateways). We ensure these partners meet equivalent data privacy and security standards."
    },
    {
        question: "9. Children's Privacy",
        answer: "VYDYO is not intended for users under the age of 18 without parental/guardian consent. We do not knowingly collect data from minors."
    },
    {
...
Address: VYDYO HealthTech Pvt Ltd, Hall Mark Sunny Side, Manchirevula, Hyderabad, Telangana, India`
    },
    {
        ...
        answer: "We may revise this Privacy Policy to reflect legal or business changes. Users will be notified via app/website or email. Continued use of VYDYO implies consent to the updated policy."
    }
];
            ...
            <div style={{ 
                ...
                <div style={{ 
                    ...
                    {privacyPolicySections.map((section, idx) => (
                        <div key={idx} style={{
                            borderBottom: idx !== privacyPolicySections.length - 1 ? "1px solid #e2e8f0" : "none"
                        }}>
                            <div
                                style={{
                                    display: "flex",
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    {openIndex === idx ? <FiMinus size={14} /> : <FiPlus size={14} />}
                                </div>
                            </div>

...
import { faHeadphones, faComment, faPaperPlane } from "@fortawesome/free-solid-svg-icons";
import { faFacebook, faTwitter, faInstagram, faLinkedin, faGithub } from "@fortawesome/free-brands-svg-icons";

const Footer: React.FC = () => {
    return (
        <footer style={{ background: "#f7fafd", position: "relative", marginTop: "40px" }}>
            <div
                style={{
                    background: "linear-gradient(90deg, #0a8efd 0%, #1ec9fd 100%)",
                    borderRadius: "32px",
                    margin: "0 auto",
                    marginTop: "-30px",
                    maxWidth: "1320px",
            ...
            <div style={{
                ...
                <div>
                    <div style={{ fontWeight: 700, marginBottom: "16px" }}>Treatments</div>
                ...
                <div>
                    <div style={{ fontWeight: 700, marginBottom: "16px" }}>Specialities</div>
                ...
                <div style={{ minWidth: "320px" }}>
                    <div style={{ fontWeight: 700, marginBottom: "16px" }}>Newsletter</div>
                    ...
                    <div style={{ marginTop: "32px" }}>
                        <div style={{ fontWeight: 700, marginBottom: "12px" }}>Connect With Us</div>
                        <div style={{ display: "flex", gap: "16px" }}>
                            ...
                            <a href="#" style={iconStyle}><FontAwesomeIcon icon={faGithub} /></a>
                        </div>
                    </div>
                </div>
            </div>
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                        <a href="#" style={linkStyle}>Legal Notice</a>
                        <span>•</span>

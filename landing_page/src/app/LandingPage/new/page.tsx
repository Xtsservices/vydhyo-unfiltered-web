            ...
            <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
                ...
                <div
                    style={{
                        ...
                        width: "150px",
                        height: "150px",
                        background: "linear-gradient(45deg, rgba(255, 87, 34, 0.1), rgba(255, 193, 7, 0.1))",
                        borderRadius: "50%",
                        filter: "blur(30px)",
                ...
                <div
                    style={{
                        ...
                        width: "120px",
                        height: "120px",
                        background: "linear-gradient(45deg, rgba(233, 30, 99, 0.1), rgba(103, 58, 183, 0.1))",
                        borderRadius: "50%",
                        filter: "blur(35px)",
                ...
                <div style={{ 
                    ...
                    <button
                        ...
                        style={{
                            ...
                            borderRadius: "50%",
                            border: "none",
                            background: currentIndex === 0 ? "rgba(226, 232, 240, 0.7)" : "rgba(66, 133, 244, 0.9)",
                            backdropFilter: "blur(10px)",
                    ...
                    <button
                        ...
                        style={{
                            ...
                            borderRadius: "50%",
                            border: "none",
                            background: currentIndex === specialities.length - 1 ? "rgba(226, 232, 240, 0.7)" : "rgba(66, 133, 244, 0.9)",
                            backdropFilter: "blur(10px)",
                            color: currentIndex === specialities.length - 1 ? "#4a5568" : "#fff",
                            fontSize: 18,
                            cursor: currentIndex === specialities.length - 1 ? "not-allowed" : "pointer",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            transition: "all 0.2s ease",
